...
<body>
    <table border="0" width="780" height="27" style="border-collapse: collapse">
        ...
        <tr>
            ...
            <td height="21" width="388">
                <span  style="font-weight: 700">
                    <a class="rulesMark" href="#como_practicar">Como Practicar</a>
                </span>
            </td>
        </tr>
    </table>
    ...
    <ul>
        ...
        <li>Todo estudiante del I al X de cualquier Universidad o Instituci&oacute;n
            T&eacute;cnica Educativa que no forme parte de la comisi&oacute;n organizadora y que
        cumpla con las dem&aacute;s condiciones.</li>
    </ul>
    <p>&nbsp;</p>
    <hr size="4" color="#000000">
    <blockquote>
    ...
    <blockquote>
        <p><font size="4">
        <span style="font-weight: 700"><a name="como_practicar">Como Practicar</a></span></font></p>
    </blockquote><hr color="#000000" size="1">
    <blockquote>
        <p>
        <span >
        <a href="http://www.topcoder.com/tc">TopCoder</a>,
        <a href="http://cm2prod.baylor.edu/">ACMICPC problems</a>
        y en espa&ntilde;ol, pueden comenzar practicando con los Problemas del Aniversario de Inform&aacute;tica 2008
        </span>
        <br>
        <p><a href="<?php echo "./";?>files/aniversario_informatica08_problems.zip" >aniversario inform&aacute;tica 08 ProblemSet</a></p>
    </blockquote>
</body>
